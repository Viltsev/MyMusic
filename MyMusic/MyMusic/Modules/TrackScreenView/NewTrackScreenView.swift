...
struct NewTrackScreenView: View {
    var body: some View {
        VStack {
            TrackCoverView()
            Spacer()
...
struct NewTrackScreenView_Previews: PreviewProvider {
...
private let mockURL = "https://soundcloud-result.s3.amazonaws.com/2023-08-26/1693077644332.mp3"
